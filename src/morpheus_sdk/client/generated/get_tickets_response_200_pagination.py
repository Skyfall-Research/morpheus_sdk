...
T = TypeVar("T", bound="GetTicketsResponse200Pagination")


@_attrs_define
class GetTicketsResponse200Pagination:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_tickets_response_200_pagination = cls(
        ...
        get_tickets_response_200_pagination.additional_properties = d
        return get_tickets_response_200_pagination
