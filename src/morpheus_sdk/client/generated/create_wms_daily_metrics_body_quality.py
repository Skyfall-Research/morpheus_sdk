...
T = TypeVar("T", bound="CreateWMSDailyMetricsBodyQuality")


@_attrs_define
class CreateWMSDailyMetricsBodyQuality:
    """Quality and error tracking metrics

    Attributes:
        pick_errors (Union[Unset, float]): Number of pick errors Example: 7.
        pack_errors (Union[Unset, float]): Number of pack errors Example: 3.
        damage_reports (Union[Unset, float]): Number of damage reports Example: 2.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_wms_daily_metrics_body_quality = cls(
        ...
        create_wms_daily_metrics_body_quality.additional_properties = d
        return create_wms_daily_metrics_body_quality
