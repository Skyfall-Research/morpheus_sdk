...
T = TypeVar("T", bound="GetAllERPCompaniesResponse200Pagination")


@_attrs_define
class GetAllERPCompaniesResponse200Pagination:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_all_erp_companies_response_200_pagination = cls(
            limit=limit,
        ...
        get_all_erp_companies_response_200_pagination.additional_properties = d
        return get_all_erp_companies_response_200_pagination
