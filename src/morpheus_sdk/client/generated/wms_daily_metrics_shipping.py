...
T = TypeVar("T", bound="WMSDailyMetricsShipping")


@_attrs_define
class WMSDailyMetricsShipping:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        wms_daily_metrics_shipping = cls(
            shipments_created=shipments_created,
            carriers_dispatched=carriers_dispatched,
            packages_shipped=packages_shipped,
        )

        wms_daily_metrics_shipping.additional_properties = d
        return wms_daily_metrics_shipping
