...
T = TypeVar("T", bound="GetWMSCycleCountsByStatusResponse200DataPagination")


@_attrs_define
class GetWMSCycleCountsByStatusResponse200DataPagination:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_wms_cycle_counts_by_status_response_200_data_pagination = cls(
        ...
        get_wms_cycle_counts_by_status_response_200_data_pagination.additional_properties = d
        return get_wms_cycle_counts_by_status_response_200_data_pagination
