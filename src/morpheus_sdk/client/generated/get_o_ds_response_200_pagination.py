...
T = TypeVar("T", bound="GetODsResponse200Pagination")


@_attrs_define
class GetODsResponse200Pagination:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_o_ds_response_200_pagination = cls(
        ...
        get_o_ds_response_200_pagination.additional_properties = d
        return get_o_ds_response_200_pagination
