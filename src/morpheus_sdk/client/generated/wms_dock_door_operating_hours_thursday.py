...
T = TypeVar("T", bound="WMSDockDoorOperatingHoursThursday")


@_attrs_define
class WMSDockDoorOperatingHoursThursday:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        wms_dock_door_operating_hours_thursday = cls(
            open_=open_,
            close=close,
        )

        wms_dock_door_operating_hours_thursday.additional_properties = d
        return wms_dock_door_operating_hours_thursday
