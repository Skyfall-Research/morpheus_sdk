...
T = TypeVar("T", bound="CreateERPPaymentBodyBankDetails")


@_attrs_define
class CreateERPPaymentBodyBankDetails:
    """Banking information for payment processing

    Attributes:
        bank_name (Union[Unset, str]):  Example: Wells Fargo.
        account_number (Union[Unset, str]):  Example: ****1234.
        routing_number (Union[Unset, str]):  Example: 121000248.
        swift (Union[Unset, str]):  Example: WFBIUS6S.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_erp_payment_body_bank_details = cls(
            bank_name=bank_name,
        ...
        create_erp_payment_body_bank_details.additional_properties = d
        return create_erp_payment_body_bank_details
