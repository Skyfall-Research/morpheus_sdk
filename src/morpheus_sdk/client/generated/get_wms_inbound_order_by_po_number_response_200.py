...
T = TypeVar("T", bound="GetWMSInboundOrderByPoNumberResponse200")


@_attrs_define
class GetWMSInboundOrderByPoNumberResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_wms_inbound_order_by_po_number_response_200 = cls(
            success=success,
            data=data,
        )

        get_wms_inbound_order_by_po_number_response_200.additional_properties = d
        return get_wms_inbound_order_by_po_number_response_200
