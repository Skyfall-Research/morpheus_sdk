...
T = TypeVar("T", bound="ApproveWMSReplenishmentResponse200")


@_attrs_define
class ApproveWMSReplenishmentResponse200:
    """
    Attributes:
        success (Union[Unset, bool]):  Example: True.
        status (Union[Unset, int]):  Example: 200.
        message (Union[Unset, str]):  Example: Replenishment approved successfully.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        approve_wms_replenishment_response_200 = cls(
            success=success,
            status=status,
            message=message,
            data=data,
        ...
        approve_wms_replenishment_response_200.additional_properties = d
        return approve_wms_replenishment_response_200
