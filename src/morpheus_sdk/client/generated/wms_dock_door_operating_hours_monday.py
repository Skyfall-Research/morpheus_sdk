...
T = TypeVar("T", bound="WMSDockDoorOperatingHoursMonday")


@_attrs_define
class WMSDockDoorOperatingHoursMonday:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        wms_dock_door_operating_hours_monday = cls(
            open_=open_,
            close=close,
        )

        wms_dock_door_operating_hours_monday.additional_properties = d
        return wms_dock_door_operating_hours_monday
