...
T = TypeVar("T", bound="AssignWMSTaskResponse200")


@_attrs_define
class AssignWMSTaskResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        assign_wms_task_response_200 = cls(
            success=success,
            data=data,
        )

        assign_wms_task_response_200.additional_properties = d
        return assign_wms_task_response_200
