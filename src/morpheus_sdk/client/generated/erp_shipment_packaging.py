...
T = TypeVar("T", bound="ERPShipmentPackaging")


@_attrs_define
class ERPShipmentPackaging:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        erp_shipment_packaging = cls(
            pallet_count=pallet_count,
            total_packages=total_packages,
            packaging_type=packaging_type,
        )

        erp_shipment_packaging.additional_properties = d
        return erp_shipment_packaging
