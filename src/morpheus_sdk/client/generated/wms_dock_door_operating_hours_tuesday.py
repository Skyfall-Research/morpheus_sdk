...
T = TypeVar("T", bound="WMSDockDoorOperatingHoursTuesday")


@_attrs_define
class WMSDockDoorOperatingHoursTuesday:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        wms_dock_door_operating_hours_tuesday = cls(
            open_=open_,
            close=close,
        )

        wms_dock_door_operating_hours_tuesday.additional_properties = d
        return wms_dock_door_operating_hours_tuesday
