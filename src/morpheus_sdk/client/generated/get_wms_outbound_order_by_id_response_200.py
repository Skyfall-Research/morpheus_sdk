...
T = TypeVar("T", bound="GetWMSOutboundOrderByIdResponse200")


@_attrs_define
class GetWMSOutboundOrderByIdResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_wms_outbound_order_by_id_response_200 = cls(
            success=success,
            status=status,
            data=data,
        )

        get_wms_outbound_order_by_id_response_200.additional_properties = d
        return get_wms_outbound_order_by_id_response_200
