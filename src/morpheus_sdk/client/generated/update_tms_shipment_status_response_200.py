...
T = TypeVar("T", bound="UpdateTMSShipmentStatusResponse200")


@_attrs_define
class UpdateTMSShipmentStatusResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_tms_shipment_status_response_200 = cls(
            success=success,
            status=status,
            data=data,
        )

        update_tms_shipment_status_response_200.additional_properties = d
        return update_tms_shipment_status_response_200
