...
T = TypeVar("T", bound="CreateWMSDistributionCenterResponse201")


@_attrs_define
class CreateWMSDistributionCenterResponse201:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_wms_distribution_center_response_201 = cls(
            success=success,
            data=data,
        )

        create_wms_distribution_center_response_201.additional_properties = d
        return create_wms_distribution_center_response_201
