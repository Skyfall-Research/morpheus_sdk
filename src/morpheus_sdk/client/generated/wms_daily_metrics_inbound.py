...
T = TypeVar("T", bound="WMSDailyMetricsInbound")


@_attrs_define
class WMSDailyMetricsInbound:
    """Inbound receiving operation metrics

    Attributes:
        po_received (Union[Unset, float]): Number of purchase orders received Example: 45.
        lines_received (Union[Unset, float]): Number of purchase order lines received Example: 320.
        ...
        receiving_hours (Union[Unset, float]): Total receiving labor hours Example: 32.5.
        units_per_hour (Union[Unset, float]): Receiving productivity - units processed per hour Example: 75.4.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        wms_daily_metrics_inbound.additional_properties = d
        return wms_daily_metrics_inbound
