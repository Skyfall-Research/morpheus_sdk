...
T = TypeVar("T", bound="TMSShipmentStatusEventEtaInfo")


@_attrs_define
class TMSShipmentStatusEventEtaInfo:
    """ETA update details for ETA_UPDATE events

    Attributes:
        previous_eta (Union[Unset, datetime.datetime]): Previous estimated time of arrival Example:
            2024-11-29T17:00:00.000Z.
        new_eta (Union[Unset, datetime.datetime]): Updated estimated time of arrival Example: 2024-11-29T16:30:00.000Z.
        delay_minutes (Union[Unset, float]): Delay in minutes (negative values indicate earlier arrival) Example: -30.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        tms_shipment_status_event_eta_info = cls(
            previous_eta=previous_eta,
            new_eta=new_eta,
            delay_minutes=delay_minutes,
        )

        tms_shipment_status_event_eta_info.additional_properties = d
        return tms_shipment_status_event_eta_info
