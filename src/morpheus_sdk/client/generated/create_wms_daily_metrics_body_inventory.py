...
T = TypeVar("T", bound="CreateWMSDailyMetricsBodyInventory")


@_attrs_define
class CreateWMSDailyMetricsBodyInventory:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_wms_daily_metrics_body_inventory = cls(
            on_hand_units=on_hand_units,
            inventory_value=inventory_value,
            turnover_rate=turnover_rate,
        )

        create_wms_daily_metrics_body_inventory.additional_properties = d
        return create_wms_daily_metrics_body_inventory
