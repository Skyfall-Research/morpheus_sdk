...
T = TypeVar("T", bound="AddTMSShipmentDelayResponse200")


@_attrs_define
class AddTMSShipmentDelayResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        add_tms_shipment_delay_response_200 = cls(
            success=success,
            status=status,
            data=data,
        )

        add_tms_shipment_delay_response_200.additional_properties = d
        return add_tms_shipment_delay_response_200
