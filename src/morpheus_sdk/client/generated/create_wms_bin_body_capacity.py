...
T = TypeVar("T", bound="CreateWMSBinBodyCapacity")


@_attrs_define
class CreateWMSBinBodyCapacity:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_wms_bin_body_capacity = cls(
            max_weight_lbs=max_weight_lbs,
            max_cubic_feet=max_cubic_feet,
            max_pallets=max_pallets,
        )

        create_wms_bin_body_capacity.additional_properties = d
        return create_wms_bin_body_capacity
