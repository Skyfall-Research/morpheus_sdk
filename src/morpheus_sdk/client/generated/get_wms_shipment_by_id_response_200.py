...
T = TypeVar("T", bound="GetWMSShipmentByIdResponse200")


@_attrs_define
class GetWMSShipmentByIdResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_wms_shipment_by_id_response_200 = cls(
            success=success,
            status=status,
            message=message,
            data=data,
        ...
        get_wms_shipment_by_id_response_200.additional_properties = d
        return get_wms_shipment_by_id_response_200
