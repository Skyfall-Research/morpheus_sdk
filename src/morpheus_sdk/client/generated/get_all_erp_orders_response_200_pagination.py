...
T = TypeVar("T", bound="GetAllERPOrdersResponse200Pagination")


@_attrs_define
class GetAllERPOrdersResponse200Pagination:
    """
    Attributes:
        limit (Union[Unset, int]):  Example: 50.
        previous_cursor (Union[Unset, str]):
        total_count (Union[Unset, int]):  Example: 75.
        has_more (Union[Unset, bool]):  Example: True.
        next_cursor (Union[Unset, str]):  Example: 507f1f77bcf86cd799439020.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_all_erp_orders_response_200_pagination = cls(
            limit=limit,
        ...
        get_all_erp_orders_response_200_pagination.additional_properties = d
        return get_all_erp_orders_response_200_pagination
