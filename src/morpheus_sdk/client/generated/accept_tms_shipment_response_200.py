...
T = TypeVar("T", bound="AcceptTMSShipmentResponse200")


@_attrs_define
class AcceptTMSShipmentResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        accept_tms_shipment_response_200 = cls(
            success=success,
            status=status,
            data=data,
        )

        accept_tms_shipment_response_200.additional_properties = d
        return accept_tms_shipment_response_200
