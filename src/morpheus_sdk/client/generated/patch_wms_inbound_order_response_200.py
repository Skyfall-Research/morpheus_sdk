...
T = TypeVar("T", bound="PatchWMSInboundOrderResponse200")


@_attrs_define
class PatchWMSInboundOrderResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_wms_inbound_order_response_200 = cls(
            success=success,
            data=data,
        )

        patch_wms_inbound_order_response_200.additional_properties = d
        return patch_wms_inbound_order_response_200
