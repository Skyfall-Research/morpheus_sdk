...
T = TypeVar("T", bound="UpdateWMSTaskPriorityResponse200")


@_attrs_define
class UpdateWMSTaskPriorityResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_wms_task_priority_response_200 = cls(
            success=success,
            data=data,
        )

        update_wms_task_priority_response_200.additional_properties = d
        return update_wms_task_priority_response_200
