...
T = TypeVar("T", bound="CreateWMSBinBodyLocation")


@_attrs_define
class CreateWMSBinBodyLocation:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_wms_bin_body_location = cls(
            aisle=aisle,
            bay=bay,
            level=level,
            position=position,
        ...
        create_wms_bin_body_location.additional_properties = d
        return create_wms_bin_body_location
