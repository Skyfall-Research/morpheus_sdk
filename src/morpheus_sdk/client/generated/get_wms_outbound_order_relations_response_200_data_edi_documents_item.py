...
T = TypeVar("T", bound="GetWMSOutboundOrderRelationsResponse200DataEdiDocumentsItem")


@_attrs_define
class GetWMSOutboundOrderRelationsResponse200DataEdiDocumentsItem:
    """
    Attributes:
        transaction_id (Union[Unset, str]):  Example: edi_txn_674565c1234567890abcdef.
        doc_type (Union[Unset, str]):  Example: 850.
        ...
        business_document_number (Union[Unset, str]):  Example: WO-20241201-001.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_wms_outbound_order_relations_response_200_data_edi_documents_item = cls(
        ...
        get_wms_outbound_order_relations_response_200_data_edi_documents_item.additional_properties = d
        return get_wms_outbound_order_relations_response_200_data_edi_documents_item
