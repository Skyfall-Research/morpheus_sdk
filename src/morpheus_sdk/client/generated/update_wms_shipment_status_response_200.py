...
T = TypeVar("T", bound="UpdateWMSShipmentStatusResponse200")


@_attrs_define
class UpdateWMSShipmentStatusResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_wms_shipment_status_response_200 = cls(
            success=success,
            status=status,
            message=message,
            data=data,
        ...
        update_wms_shipment_status_response_200.additional_properties = d
        return update_wms_shipment_status_response_200
