...
T = TypeVar("T", bound="CreateWMSTaskBodyFrom")


@_attrs_define
class CreateWMSTaskBodyFrom:
    """Source location details

    Attributes:
        bin_id (Union[Unset, str]):  Example: BIN-A001.
        bin_code (Union[Unset, str]):  Example: A-001.
        zone_id (Union[Unset, str]):  Example: ZONE-PICK.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_wms_task_body_from = cls(
            bin_id=bin_id,
            bin_code=bin_code,
            zone_id=zone_id,
        )

        create_wms_task_body_from.additional_properties = d
        return create_wms_task_body_from
