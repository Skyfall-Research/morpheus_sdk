...
T = TypeVar("T", bound="GetTMSShipmentsByStatusResponse200Pagination")


@_attrs_define
class GetTMSShipmentsByStatusResponse200Pagination:
    """
    Attributes:
        total_count (Union[Unset, int]):  Example: 156.
        limit (Union[Unset, int]):  Example: 50.
        has_more (Union[Unset, bool]):  Example: True.
        next_cursor (Union[None, Unset, str]):  Example: 507f1f77bcf86cd799439012.
        previous_cursor (Union[None, Unset, str]):  Example: 507f1f77bcf86cd799439010.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_tms_shipments_by_status_response_200_pagination = cls(
        ...
        get_tms_shipments_by_status_response_200_pagination.additional_properties = d
        return get_tms_shipments_by_status_response_200_pagination
