...
T = TypeVar("T", bound="GetWMSOutboundOrderRelationsResponse200DataFinanceTransaction")


@_attrs_define
class GetWMSOutboundOrderRelationsResponse200DataFinanceTransaction:
    """Related finance transaction

    Attributes:
        transaction_id (Union[Unset, str]):  Example: fin_txn_674565c1234567890abcdef.
        type_ (Union[Unset, str]):  Example: payment_in.
        amount (Union[Unset, float]):  Example: 25000.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_wms_outbound_order_relations_response_200_data_finance_transaction = cls(
        ...
        get_wms_outbound_order_relations_response_200_data_finance_transaction.additional_properties = d
        return get_wms_outbound_order_relations_response_200_data_finance_transaction
