...
T = TypeVar("T", bound="GetTMSInTransitShipmentsResponse200Pagination")


@_attrs_define
class GetTMSInTransitShipmentsResponse200Pagination:
    """
    Attributes:
        total_count (Union[Unset, int]):  Example: 42.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_tms_in_transit_shipments_response_200_pagination = cls(
        ...
        get_tms_in_transit_shipments_response_200_pagination.additional_properties = d
        return get_tms_in_transit_shipments_response_200_pagination
