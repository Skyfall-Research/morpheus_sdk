...
T = TypeVar("T", bound="WMSDistributionCenterAddress")


@_attrs_define
class WMSDistributionCenterAddress:
    ...
    Attributes:
        ...
        zip_code (Union[Unset, str]): Postal/ZIP code Example: 30309.
        country (Union[Unset, str]): Country code Example: US.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        wms_distribution_center_address = cls(
            street=street,
            city=city,
            state=state,
            zip_code=zip_code,
        ...
        wms_distribution_center_address.additional_properties = d
        return wms_distribution_center_address
