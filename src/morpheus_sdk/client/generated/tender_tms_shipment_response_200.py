...
T = TypeVar("T", bound="TenderTMSShipmentResponse200")


@_attrs_define
class TenderTMSShipmentResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        tender_tms_shipment_response_200 = cls(
            success=success,
            status=status,
            data=data,
        )

        tender_tms_shipment_response_200.additional_properties = d
        return tender_tms_shipment_response_200
