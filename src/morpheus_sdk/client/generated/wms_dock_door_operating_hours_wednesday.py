...
T = TypeVar("T", bound="WMSDockDoorOperatingHoursWednesday")


@_attrs_define
class WMSDockDoorOperatingHoursWednesday:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        wms_dock_door_operating_hours_wednesday = cls(
            open_=open_,
            close=close,
        )

        wms_dock_door_operating_hours_wednesday.additional_properties = d
        return wms_dock_door_operating_hours_wednesday
