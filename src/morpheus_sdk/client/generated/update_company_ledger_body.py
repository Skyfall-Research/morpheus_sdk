...
T = TypeVar("T", bound="UpdateCompanyLedgerBody")


@_attrs_define
class UpdateCompanyLedgerBody:
    """
    Attributes:
        cash (Union[Unset, float]): Updated cash position Example: 28000.
        total_receivables (Union[Unset, float]): Updated accounts receivable total Example: 42000.
        total_payables (Union[Unset, float]): Updated accounts payable total Example: 20000.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_company_ledger_body = cls(
            cash=cash,
            total_receivables=total_receivables,
            total_payables=total_payables,
        )

        update_company_ledger_body.additional_properties = d
        return update_company_ledger_body
