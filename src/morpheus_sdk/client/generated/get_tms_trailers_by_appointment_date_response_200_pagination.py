...
T = TypeVar("T", bound="GetTMSTrailersByAppointmentDateResponse200Pagination")


@_attrs_define
class GetTMSTrailersByAppointmentDateResponse200Pagination:
    """
    Attributes:
        total_count (Union[Unset, int]):  Example: 15.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_tms_trailers_by_appointment_date_response_200_pagination = cls(
        ...
        get_tms_trailers_by_appointment_date_response_200_pagination.additional_properties = d
        return get_tms_trailers_by_appointment_date_response_200_pagination
