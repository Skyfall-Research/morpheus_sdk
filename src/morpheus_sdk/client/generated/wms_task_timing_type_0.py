...
T = TypeVar("T", bound="WMSTaskTimingType0")


@_attrs_define
class WMSTaskTimingType0:
    """Comprehensive timing and performance tracking

    Attributes:
        created_at (Union[None, Unset, datetime.datetime]): Task creation timestamp Example: 2024-11-27T09:00:00Z.
        released_at (Union[None, Unset, datetime.datetime]): Task release timestamp (becomes available) Example:
            2024-11-27T09:05:00Z.
        assigned_at (Union[None, Unset, datetime.datetime]): Task assignment timestamp Example: 2024-11-27T09:15:00Z.
        started_at (Union[None, Unset, datetime.datetime]): Task execution start timestamp Example:
            2024-11-27T09:20:00Z.
        completed_at (Union[None, Unset, datetime.datetime]): Task completion timestamp Example: 2024-11-27T09:35:00Z.
        estimated_duration (Union[None, Unset, float]): Estimated duration in minutes Example: 15.
        actual_duration (Union[None, Unset, float]): Actual duration in minutes (calculated on completion) Example: 12.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        wms_task_timing_type_0.additional_properties = d
        return wms_task_timing_type_0
