...
T = TypeVar("T", bound="CreateWMSDailyMetricsBodyLabor")


@_attrs_define
class CreateWMSDailyMetricsBodyLabor:
    ...
    Attributes:
        ...
        productive_hours (Union[Unset, float]): Productive labor hours Example: 165.5.
        indirect_hours (Union[Unset, float]): Indirect labor hours Example: 26.5.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_wms_daily_metrics_body_labor = cls(
        ...
        create_wms_daily_metrics_body_labor.additional_properties = d
        return create_wms_daily_metrics_body_labor
