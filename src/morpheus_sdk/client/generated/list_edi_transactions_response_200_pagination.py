...
T = TypeVar("T", bound="ListEdiTransactionsResponse200Pagination")


@_attrs_define
class ListEdiTransactionsResponse200Pagination:
    """
    Attributes:
        total_count (Union[Unset, int]):  Example: 156.
        limit (Union[Unset, int]):  Example: 10.
        has_more (Union[Unset, bool]):  Example: True.
        next_cursor (Union[None, Unset, str]):  Example: 507f1f77bcf86cd799439020.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_edi_transactions_response_200_pagination = cls(
        ...
        list_edi_transactions_response_200_pagination.additional_properties = d
        return list_edi_transactions_response_200_pagination
