...
from ...models.get_zone_by_code_response_200 import GetZoneByCodeResponse200
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/{world_id}/wms/zones/warehouse/{warehouse_id}/code/{zone_code}",
    }
...
) -> Optional[Union[ErrorResponse, GetZoneByCodeResponse200]]:
    if response.status_code == 200:
        response_200 = GetZoneByCodeResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ErrorResponse, GetZoneByCodeResponse200]]:
    return Response(
...
def sync_detailed(
    ...
    **Use Cases**:
    ...
    Args:
        ...
        zone_code (str):  Example: picking-zone-a.
...
def sync(
    ...
    **Use Cases**:
    ...
    Returns:
        Union[ErrorResponse, GetZoneByCodeResponse200]
    """
