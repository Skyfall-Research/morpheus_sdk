...
from ...models.delete_erp_product_response_200 import DeleteERPProductResponse200
...
) -> Optional[Union[DeleteERPProductResponse200, ErrorResponse]]:
    if response.status_code == 200:
        response_200 = DeleteERPProductResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DeleteERPProductResponse200, ErrorResponse]]:
    return Response(
...
def sync(
    ...
    **Important**: Ensure no active transactions reference this product before deletion.
    ...
    Returns:
        Union[DeleteERPProductResponse200, ErrorResponse]
    """
