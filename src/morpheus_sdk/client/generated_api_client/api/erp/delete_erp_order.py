...
from ...models.delete_erp_order_response_200 import DeleteERPOrderResponse200
...
) -> Optional[Union[DeleteERPOrderResponse200, ErrorResponse]]:
    if response.status_code == 200:
        response_200 = DeleteERPOrderResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DeleteERPOrderResponse200, ErrorResponse]]:
    return Response(
...
def sync(
    ...
    **Important**: Ensure order is in appropriate status for deletion before removing.
    ...
    Returns:
        Union[DeleteERPOrderResponse200, ErrorResponse]
    """
