...
from ...models.update_erp_shipment_lines_body import UpdateERPShipmentLinesBody
from ...models.update_erp_shipment_lines_response_200 import UpdateERPShipmentLinesResponse200
...
def _get_kwargs(
    ...
    shipment_id: str,
    *,
    body: UpdateERPShipmentLinesBody,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": f"/{world_id}/erp/shipments/{shipment_id}/lines",
    }
...
) -> Optional[Union[ErrorResponse, UpdateERPShipmentLinesResponse200]]:
    if response.status_code == 200:
        response_200 = UpdateERPShipmentLinesResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ErrorResponse, UpdateERPShipmentLinesResponse200]]:
    return Response(
...
def sync(
    ...
    **Use Cases**:
    ...
    Returns:
        Union[ErrorResponse, UpdateERPShipmentLinesResponse200]
    """
