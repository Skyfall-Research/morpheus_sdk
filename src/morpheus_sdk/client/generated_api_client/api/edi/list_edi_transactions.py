...
from ...models.list_edi_transactions_direction import ListEdiTransactionsDirection
from ...models.list_edi_transactions_doc_type import ListEdiTransactionsDocType
from ...models.list_edi_transactions_response_200 import ListEdiTransactionsResponse200
from ...models.list_edi_transactions_status import ListEdiTransactionsStatus
...
def _get_kwargs(
    ...
    *,
    ...
    doc_type: Union[Unset, ListEdiTransactionsDocType] = UNSET,
    direction: Union[Unset, ListEdiTransactionsDirection] = UNSET,
    status: Union[Unset, ListEdiTransactionsStatus] = UNSET,
...
) -> Optional[Union[ErrorResponse, ListEdiTransactionsResponse200]]:
    if response.status_code == 200:
        response_200 = ListEdiTransactionsResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ErrorResponse, ListEdiTransactionsResponse200]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """List EDI transactions with advanced filtering
    ...
    Args:
        ...
        doc_type (Union[Unset, ListEdiTransactionsDocType]):  Example: 810.
        direction (Union[Unset, ListEdiTransactionsDirection]):  Example: INBOUND.
        status (Union[Unset, ListEdiTransactionsStatus]):  Example: ERRORED.
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ErrorResponse, ListEdiTransactionsResponse200]
    """
