...
T = TypeVar("T", bound="GetAllWarehousesResponse200Data")


@_attrs_define
class GetAllWarehousesResponse200Data:
    """
    Attributes:
        items (Union[Unset, list['WMSWarehouse']]):
        total_count (Union[Unset, int]):  Example: 12.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_all_warehouses_response_200_data = cls(
            items=items,
        ...
        get_all_warehouses_response_200_data.additional_properties = d
        return get_all_warehouses_response_200_data
