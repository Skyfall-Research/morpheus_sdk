...
T = TypeVar("T", bound="GetTMSInboundTrailersByStatusResponse200Pagination")


@_attrs_define
class GetTMSInboundTrailersByStatusResponse200Pagination:
    """
    Attributes:
        total_count (Union[Unset, int]):  Example: 127.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_tms_inbound_trailers_by_status_response_200_pagination = cls(
        ...
        get_tms_inbound_trailers_by_status_response_200_pagination.additional_properties = d
        return get_tms_inbound_trailers_by_status_response_200_pagination
