...
T = TypeVar("T", bound="CreateWMSOutboundOrderResponse201")


@_attrs_define
class CreateWMSOutboundOrderResponse201:
    """
    Attributes:
        success (Union[Unset, bool]):  Example: True.
        status (Union[Unset, int]):  Example: 201.
        message (Union[Unset, str]):  Example: Outbound order created successfully.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_wms_outbound_order_response_201 = cls(
            success=success,
            status=status,
            message=message,
            data=data,
        ...
        create_wms_outbound_order_response_201.additional_properties = d
        return create_wms_outbound_order_response_201
