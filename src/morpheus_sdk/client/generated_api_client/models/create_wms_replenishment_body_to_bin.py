...
T = TypeVar("T", bound="CreateWMSReplenishmentBodyToBin")


@_attrs_define
class CreateWMSReplenishmentBodyToBin:
    """Destination bin details with capacity

    Attributes:
        bin_id (Union[Unset, str]):  Example: BIN-P001.
        bin_code (Union[Unset, str]):  Example: P-001.
        current_quantity (Union[Unset, float]):  Example: 50.
        min_quantity (Union[Unset, float]):  Example: 100.
        max_quantity (Union[Unset, float]):  Example: 200.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_wms_replenishment_body_to_bin = cls(
            bin_id=bin_id,
            bin_code=bin_code,
        ...
        create_wms_replenishment_body_to_bin.additional_properties = d
        return create_wms_replenishment_body_to_bin
