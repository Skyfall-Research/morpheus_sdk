...
T = TypeVar("T", bound="CreateERPShipmentResponse201")


@_attrs_define
class CreateERPShipmentResponse201:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_erp_shipment_response_201 = cls(
            success=success,
            status=status,
            message=message,
            data=data,
        ...
        create_erp_shipment_response_201.additional_properties = d
        return create_erp_shipment_response_201
