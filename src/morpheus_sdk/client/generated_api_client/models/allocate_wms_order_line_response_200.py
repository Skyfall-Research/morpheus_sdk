...
T = TypeVar("T", bound="AllocateWMSOrderLineResponse200")


@_attrs_define
class AllocateWMSOrderLineResponse200:
    """
    Attributes:
        success (Union[Unset, bool]):  Example: True.
        status (Union[Unset, int]):  Example: 200.
        message (Union[Unset, str]):  Example: Order line allocated successfully.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        allocate_wms_order_line_response_200 = cls(
            success=success,
            status=status,
            message=message,
            data=data,
        ...
        allocate_wms_order_line_response_200.additional_properties = d
        return allocate_wms_order_line_response_200
