...
T = TypeVar("T", bound="GetWMSDockDoorByIdResponse200")


@_attrs_define
class GetWMSDockDoorByIdResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_wms_dock_door_by_id_response_200 = cls(
            success=success,
            data=data,
        )

        get_wms_dock_door_by_id_response_200.additional_properties = d
        return get_wms_dock_door_by_id_response_200
