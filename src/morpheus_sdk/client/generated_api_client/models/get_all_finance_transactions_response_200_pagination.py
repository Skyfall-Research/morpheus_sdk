...
T = TypeVar("T", bound="GetAllFinanceTransactionsResponse200Pagination")


@_attrs_define
class GetAllFinanceTransactionsResponse200Pagination:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_all_finance_transactions_response_200_pagination = cls(
            limit=limit,
        ...
        get_all_finance_transactions_response_200_pagination.additional_properties = d
        return get_all_finance_transactions_response_200_pagination
