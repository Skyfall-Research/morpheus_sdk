...
T = TypeVar("T", bound="ERPPaymentBankDetails")


@_attrs_define
class ERPPaymentBankDetails:
    """Banking information for payment processing

    Attributes:
        bank_name (Union[Unset, str]): Name of the bank Example: Wells Fargo.
        account_number (Union[Unset, str]): Bank account number (masked for security) Example: ****1234.
        routing_number (Union[Unset, str]): Bank routing number Example: 121000248.
        swift (Union[Unset, str]): SWIFT code for international payments Example: WFBIUS6S.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        erp_payment_bank_details.additional_properties = d
        return erp_payment_bank_details
