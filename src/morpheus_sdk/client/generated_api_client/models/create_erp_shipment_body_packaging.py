...
T = TypeVar("T", bound="CreateERPShipmentBodyPackaging")


@_attrs_define
class CreateERPShipmentBodyPackaging:
    """Packaging information

    Attributes:
        pallet_count (Union[Unset, float]):  Example: 2.
        total_packages (Union[Unset, float]):  Example: 10.
        packaging_type (Union[Unset, str]):  Example: BOX.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_erp_shipment_body_packaging = cls(
            pallet_count=pallet_count,
            total_packages=total_packages,
            packaging_type=packaging_type,
        )

        create_erp_shipment_body_packaging.additional_properties = d
        return create_erp_shipment_body_packaging
