...
T = TypeVar("T", bound="WMSDailyMetricsPicking")


@_attrs_define
class WMSDailyMetricsPicking:
    """Picking operation metrics

    Attributes:
        orders_shipped (Union[Unset, float]): Number of orders shipped Example: 125.
        lines_picked (Union[Unset, float]): Number of order lines picked Example: 890.
        units_picked (Union[Unset, float]): Total units picked Example: 2240.
        picking_hours (Union[Unset, float]): Total picking labor hours Example: 45.5.
        lines_per_hour (Union[Unset, float]): Picking productivity - lines per hour Example: 19.6.
        units_per_hour (Union[Unset, float]): Picking productivity - units per hour Example: 49.2.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        wms_daily_metrics_picking.additional_properties = d
        return wms_daily_metrics_picking
