...
from ..models.tms_inbound_trailer_cargo_trailer_type import TMSInboundTrailerCargoTrailerType
from ..types import UNSET, Unset

T = TypeVar("T", bound="TMSInboundTrailerCargo")


@_attrs_define
class TMSInboundTrailerCargo:
    ...
    Attributes:
        ...
        trailer_type (Union[Unset, TMSInboundTrailerCargoTrailerType]): Type of trailer equipment Example: DRY_VAN.
    ...
    trailer_type: Union[Unset, TMSInboundTrailerCargoTrailerType] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        trailer_type: Union[Unset, TMSInboundTrailerCargoTrailerType]
        if isinstance(_trailer_type, Unset):
            trailer_type = UNSET
        else:
            trailer_type = TMSInboundTrailerCargoTrailerType(_trailer_type)

        seal_number = d.pop("sealNumber", UNSET)

        tms_inbound_trailer_cargo = cls(
        ...
        tms_inbound_trailer_cargo.additional_properties = d
        return tms_inbound_trailer_cargo
