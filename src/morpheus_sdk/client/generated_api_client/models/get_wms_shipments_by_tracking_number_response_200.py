...
T = TypeVar("T", bound="GetWMSShipmentsByTrackingNumberResponse200")


@_attrs_define
class GetWMSShipmentsByTrackingNumberResponse200:
    """
    Attributes:
        success (Union[Unset, bool]):  Example: True.
        status (Union[Unset, int]):  Example: 200.
        message (Union[Unset, str]):  Example: Shipments by tracking number retrieved successfully.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_wms_shipments_by_tracking_number_response_200 = cls(
            success=success,
            status=status,
            message=message,
            data=data,
        ...
        get_wms_shipments_by_tracking_number_response_200.additional_properties = d
        return get_wms_shipments_by_tracking_number_response_200
