...
T = TypeVar("T", bound="GetWMSOutboundOrderRelationsResponse200DataErpOrder")


@_attrs_define
class GetWMSOutboundOrderRelationsResponse200DataErpOrder:
    """Related ERP sales order

    Attributes:
        order_id (Union[Unset, str]):  Example: SO-2024-001234.
        status (Union[Unset, str]):  Example: APPROVED.
        total_amount (Union[Unset, float]):  Example: 25000.
        customer_id (Union[Unset, str]):  Example: CUST-001.
        partner_id (Union[Unset, str]):  Example: PARTNER-001.
        po_type (Union[Unset, str]):  Example: SALES.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_wms_outbound_order_relations_response_200_data_erp_order = cls(
            order_id=order_id,
            status=status,
        ...
        get_wms_outbound_order_relations_response_200_data_erp_order.additional_properties = d
        return get_wms_outbound_order_relations_response_200_data_erp_order
