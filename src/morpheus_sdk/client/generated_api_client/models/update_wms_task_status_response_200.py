...
T = TypeVar("T", bound="UpdateWMSTaskStatusResponse200")


@_attrs_define
class UpdateWMSTaskStatusResponse200:
    """
    Attributes:
        success (Union[Unset, bool]):  Example: True.
        status (Union[Unset, int]):  Example: 200.
        message (Union[Unset, str]):  Example: Task status updated successfully.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_wms_task_status_response_200 = cls(
            success=success,
            status=status,
            message=message,
            data=data,
        ...
        update_wms_task_status_response_200.additional_properties = d
        return update_wms_task_status_response_200
