...
T = TypeVar("T", bound="GetAllERPShipmentsResponse200Pagination")


@_attrs_define
class GetAllERPShipmentsResponse200Pagination:
    """
    Attributes:
        ...
        next_cursor (Union[Unset, str]):  Example: 507f1f77bcf86cd799439030.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_all_erp_shipments_response_200_pagination = cls(
            limit=limit,
        ...
        get_all_erp_shipments_response_200_pagination.additional_properties = d
        return get_all_erp_shipments_response_200_pagination
