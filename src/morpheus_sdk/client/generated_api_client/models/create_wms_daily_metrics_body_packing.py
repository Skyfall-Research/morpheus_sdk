...
T = TypeVar("T", bound="CreateWMSDailyMetricsBodyPacking")


@_attrs_define
class CreateWMSDailyMetricsBodyPacking:
    ...
    Attributes:
        ...
        packing_hours (Union[Unset, float]): Total packing hours Example: 24.
        orders_per_hour (Union[Unset, float]): Orders packed per hour Example: 5.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_wms_daily_metrics_body_packing = cls(
        ...
        create_wms_daily_metrics_body_packing.additional_properties = d
        return create_wms_daily_metrics_body_packing
