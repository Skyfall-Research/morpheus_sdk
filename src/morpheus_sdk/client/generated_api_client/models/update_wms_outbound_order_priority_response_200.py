...
T = TypeVar("T", bound="UpdateWMSOutboundOrderPriorityResponse200")


@_attrs_define
class UpdateWMSOutboundOrderPriorityResponse200:
    """
    Attributes:
        success (Union[Unset, bool]):  Example: True.
        message (Union[Unset, str]):  Example: Order priority updated successfully.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_wms_outbound_order_priority_response_200 = cls(
            success=success,
            message=message,
            data=data,
        )

        update_wms_outbound_order_priority_response_200.additional_properties = d
        return update_wms_outbound_order_priority_response_200
