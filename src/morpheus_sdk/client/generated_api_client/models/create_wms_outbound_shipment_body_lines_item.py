...
T = TypeVar("T", bound="CreateWMSOutboundShipmentBodyLinesItem")


@_attrs_define
class CreateWMSOutboundShipmentBodyLinesItem:
    """
    Attributes:
        line_number (float): Sequential line number Example: 1.
        sku (str): Product SKU Example: SKU-WIDGET-001.
        quantity_shipped (float): Quantity included in shipment Example: 25.
        ...
        product_name (Union[Unset, str]): Product description Example: Premium Widget Assembly.
        ...
        lot_number (Union[Unset, str]): Lot/batch number Example: LOT-20241201-A.
        serial_numbers (Union[Unset, list[str]]): Serial numbers for serialized items Example: ['SN123456', 'SN123457'].
        pallet_id (Union[Unset, str]): Pallet identifier Example: PLT-001.
        package_count (Union[Unset, float]): Number of packages Example: 2.
        weight (Union[Unset, float]): Line weight Example: 15.5.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_wms_outbound_shipment_body_lines_item = cls(
        ...
        create_wms_outbound_shipment_body_lines_item.additional_properties = d
        return create_wms_outbound_shipment_body_lines_item
