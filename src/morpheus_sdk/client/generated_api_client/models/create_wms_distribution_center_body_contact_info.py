...
T = TypeVar("T", bound="CreateWMSDistributionCenterBodyContactInfo")


@_attrs_define
class CreateWMSDistributionCenterBodyContactInfo:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_wms_distribution_center_body_contact_info = cls(
            phone=phone,
            email=email,
            manager=manager,
        )

        create_wms_distribution_center_body_contact_info.additional_properties = d
        return create_wms_distribution_center_body_contact_info
