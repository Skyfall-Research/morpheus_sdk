...
T = TypeVar("T", bound="TMSShipmentStatusEventInputLocationInfo")


@_attrs_define
class TMSShipmentStatusEventInputLocationInfo:
    """Location information (for LOCATION_UPDATE events)
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        tms_shipment_status_event_input_location_info = cls(
            latitude=latitude,
            longitude=longitude,
            city=city,
            state=state,
        ...
        tms_shipment_status_event_input_location_info.additional_properties = d
        return tms_shipment_status_event_input_location_info
