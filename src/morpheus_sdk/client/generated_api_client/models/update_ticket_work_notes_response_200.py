...
T = TypeVar("T", bound="UpdateTicketWorkNotesResponse200")


@_attrs_define
class UpdateTicketWorkNotesResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_ticket_work_notes_response_200 = cls(
            success=success,
            status=status,
            data=data,
        )

        update_ticket_work_notes_response_200.additional_properties = d
        return update_ticket_work_notes_response_200
