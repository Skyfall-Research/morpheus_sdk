...
T = TypeVar("T", bound="TMSInboundTrailerCarrierInfo")


@_attrs_define
class TMSInboundTrailerCarrierInfo:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        tms_inbound_trailer_carrier_info = cls(
        ...
        tms_inbound_trailer_carrier_info.additional_properties = d
        return tms_inbound_trailer_carrier_info
