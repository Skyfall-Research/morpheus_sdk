...
T = TypeVar("T", bound="TMSShipmentStatusEventStatusInfo")


@_attrs_define
class TMSShipmentStatusEventStatusInfo:
    """Status change details for STATUS_CHANGE events
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        tms_shipment_status_event_status_info = cls(
            previous_status=previous_status,
            new_status=new_status,
        )

        tms_shipment_status_event_status_info.additional_properties = d
        return tms_shipment_status_event_status_info
