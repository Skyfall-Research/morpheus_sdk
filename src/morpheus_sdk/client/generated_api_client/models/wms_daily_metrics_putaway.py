...
T = TypeVar("T", bound="WMSDailyMetricsPutaway")


@_attrs_define
class WMSDailyMetricsPutaway:
    ...
    Attributes:
        ...
        putaway_hours (Union[Unset, float]): Total putaway labor hours Example: 18.5.
        pallets_per_hour (Union[Unset, float]): Putaway productivity - pallets per hour Example: 1.4.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        wms_daily_metrics_putaway.additional_properties = d
        return wms_daily_metrics_putaway
