...
T = TypeVar("T", bound="ProcessTMSEdi214UpdateResponse200")


@_attrs_define
class ProcessTMSEdi214UpdateResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        process_tms_edi_214_update_response_200 = cls(
            success=success,
            status=status,
            data=data,
        )

        process_tms_edi_214_update_response_200.additional_properties = d
        return process_tms_edi_214_update_response_200
