...
T = TypeVar("T", bound="CreateWMSTaskResponse201")


@_attrs_define
class CreateWMSTaskResponse201:
    """
    Attributes:
        success (Union[Unset, bool]):  Example: True.
        status (Union[Unset, int]):  Example: 201.
        message (Union[Unset, str]):  Example: Task created successfully.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_wms_task_response_201 = cls(
            success=success,
            status=status,
            message=message,
            data=data,
        ...
        create_wms_task_response_201.additional_properties = d
        return create_wms_task_response_201
