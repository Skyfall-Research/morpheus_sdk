...
T = TypeVar("T", bound="WMSDockDoorOperatingHoursFriday")


@_attrs_define
class WMSDockDoorOperatingHoursFriday:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        wms_dock_door_operating_hours_friday = cls(
            open_=open_,
            close=close,
        )

        wms_dock_door_operating_hours_friday.additional_properties = d
        return wms_dock_door_operating_hours_friday
