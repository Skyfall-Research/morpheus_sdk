...
T = TypeVar("T", bound="AddWMSTrackingEventResponse200")


@_attrs_define
class AddWMSTrackingEventResponse200:
    """
    Attributes:
        success (Union[Unset, bool]):  Example: True.
        status (Union[Unset, int]):  Example: 200.
        message (Union[Unset, str]):  Example: Tracking event added successfully.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        add_wms_tracking_event_response_200 = cls(
            success=success,
            status=status,
            message=message,
            data=data,
        ...
        add_wms_tracking_event_response_200.additional_properties = d
        return add_wms_tracking_event_response_200
