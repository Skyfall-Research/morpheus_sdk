...
from ..models.payment_allocation_allocation_method import PaymentAllocationAllocationMethod
from ..types import UNSET, Unset

T = TypeVar("T", bound="PaymentAllocation")


@_attrs_define
class PaymentAllocation:
    """Individual payment allocation to invoice with tracking details

    Attributes:
        invoice_number (str): Invoice number for allocation (required) Example: INV_507f1f77bcf86cd799439016.
        applied_amount (float): Amount applied to this invoice (required) Example: 750.
        discount_taken (Union[Unset, float]): Early payment discount amount taken Example: 15.
        unapplied_amount (Union[Unset, float]): Amount remaining unapplied for this allocation
        allocation_method (Union[Unset, PaymentAllocationAllocationMethod]): Method used for this allocation Example:
            FIFO.
    """
    ...
    allocation_method: Union[Unset, PaymentAllocationAllocationMethod] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        allocation_method: Union[Unset, PaymentAllocationAllocationMethod]
        if isinstance(_allocation_method, Unset):
            allocation_method = UNSET
        else:
            allocation_method = PaymentAllocationAllocationMethod(_allocation_method)

        payment_allocation = cls(
        ...
        payment_allocation.additional_properties = d
