...
T = TypeVar("T", bound="UpdateERPInvoiceResponse200")


@_attrs_define
class UpdateERPInvoiceResponse200:
    """
    Attributes:
        success (Union[Unset, bool]):  Example: True.
        status (Union[Unset, int]):  Example: 200.
        message (Union[Unset, str]):  Example: Invoice updated successfully.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_erp_invoice_response_200 = cls(
            success=success,
            status=status,
            message=message,
            data=data,
        ...
        update_erp_invoice_response_200.additional_properties = d
        return update_erp_invoice_response_200
