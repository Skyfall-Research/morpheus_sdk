...
T = TypeVar("T", bound="UpdateWMSDailyMetricsBodyInbound")


@_attrs_define
class UpdateWMSDailyMetricsBodyInbound:
    """Updated inbound receiving metrics

    Attributes:
        po_received (Union[Unset, float]):  Example: 47.
        lines_received (Union[Unset, float]):  Example: 335.
        units_received (Union[Unset, float]):  Example: 2580.
        pallets_received (Union[Unset, float]):  Example: 30.
        receiving_hours (Union[Unset, float]):  Example: 34.
        units_per_hour (Union[Unset, float]):  Example: 75.9.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_wms_daily_metrics_body_inbound = cls(
        ...
        update_wms_daily_metrics_body_inbound.additional_properties = d
        return update_wms_daily_metrics_body_inbound
